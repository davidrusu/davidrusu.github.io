...
Elm.Header.make = function (_elm) {
   ...
   var navButton = function (_p1) {
      var _p2 = _p1;
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("nav_button")]),
      _U.list([A2($Html.a,_U.list([$Html$Attributes.href(_p2._1)]),_U.list([$Html.text(_p2._0)]))]));
   };
   var viewNav = function (model) {    return A2($List.map,navButton,model.nav);};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("header")]),
      _U.list([navButton(model.home),A2($Html.div,_U.list([$Html$Attributes.$class("nav")]),viewNav(model))]));
   });
   var NoOp = {ctor: "NoOp"};
   var create = F3(function (home,nav,selected) {    return {home: home,nav: nav,selected: selected};});
   var statsPath = "http://davidrusu.github.io/mastery/";
   var basePath = "https://davidrusu.github.io";
   var projectsPath = A2($Basics._op["++"],basePath,"/pages/projects.html");
   var teasPath = A2($Basics._op["++"],basePath,"/pages/tea_log.html");
   var init = A3(create,
   {ctor: "_Tuple2",_0: "David Rusu",_1: basePath},
   _U.list([{ctor: "_Tuple2",_0: "Projects",_1: projectsPath},{ctor: "_Tuple2",_0: "Stats",_1: statsPath},{ctor: "_Tuple2",_0: "Tea Log",_1: teasPath}]),
   -1);
   var Model = F3(function (a,b,c) {    return {home: a,nav: b,selected: c};});
   return _elm.Header.values = {_op: _op,init: init,update: update,view: view,Model: Model};
};
Elm.Utils = Elm.Utils || {};
Elm.Utils.make = function (_elm) {
   ...
   return _elm.Utils.values = {_op: _op,css: css};
};
Elm.Native.Date = {};
...
Elm.Projects.make = function (_elm) {
   "use strict";
   _elm.Projects = _elm.Projects || {};
   if (_elm.Projects.values) return _elm.Projects.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var viewTitle = F2(function (address,project) {
      var link = function () {
         var _p0 = project.url;
         if (_p0.ctor === "Nothing") {
               ...
               return A2($Html.a,
               _U.list([$Html$Attributes.$class("icon_btn"),$Html$Attributes.href(_p0._0)]),
               _U.list([A2($Html.img,_U.list([$Html$Attributes.src("./link_icon.png")]),_U.list([]))]));
            }
      }();
      var github = function () {
         var _p1 = project.code;
         if (_p1.ctor === "Nothing") {
               return A2($Html.div,_U.list([]),_U.list([]));
            } else {
               return A2($Html.a,
               _U.list([$Html$Attributes.$class("icon_btn"),$Html$Attributes.href(_p1._0)]),
               _U.list([A2($Html.img,_U.list([$Html$Attributes.src("./GitHub-Mark-32px.png")]),_U.list([]))]));
            }
      }();
      var name = function () {
         var _p2 = project.url;
         if (_p2.ctor === "Nothing") {
               return $Html.text(project.name);
            } else {
               return A2($Html.a,_U.list([$Html$Attributes.href(_p2._0)]),_U.list([$Html.text(project.name)]));
            }
      }();
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("project_header")]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("project_name")]),_U.list([name]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("project_links")]),_U.list([link,github]))]));
   });
   var viewTag = F2(function (address,tag) {    return A2($Html.div,_U.list([$Html$Attributes.$class("tag")]),_U.list([$Html.text(tag)]));});
   var viewProject = F2(function (address,project) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("project")]),
      _U.list([A2($Html.img,_U.list([$Html$Attributes.$class("project_logo"),$Html$Attributes.src(project.thumbnail)]),_U.list([]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("project_details")]),
              _U.list([A2(viewTitle,address,project)
                      ,$Markdown.toHtml(project.description)
                      ,A2($Html.div,_U.list([$Html$Attributes.$class("tag-list")]),A2($List.map,viewTag(address),project.tech))]))]));
   });
   ...
   var update = F2(function (action,model) {
      ...
      if (_p4.ctor === "NoOp") {
            ...
            return _U.update(model,{header: A2($Header.update,_p4._0,model.header)});
         }
   });
   var ModifyHeader = function (a) {    return {ctor: "ModifyHeader",_0: a};};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([$Utils.css("../style.css")
              ,A2($Header.view,A2($Signal.forwardTo,address,ModifyHeader),model.header)
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("content")]),
              _U.list([A2($Html.div,_U.list([]),A2($List.map,viewProject(address),model.projects))]))]));
   });
   var NoOp = {ctor: "NoOp"};
   var actionMailbox = $Signal.mailbox(NoOp);
   var Model = F2(function (a,b) {    return {projects: a,header: b};});
   var Project = F6(function (a,b,c,d,e,f) {    return {name: a,description: b,tech: c,thumbnail: d,url: e,code: f};});
   var projects = _U.list([{name: "Rooster Engine"
                           ...
                           ,tech: _U.list(["Game Engine","Rigid Body Physics","Continuous Collision Detection","Java"])
                           ,url: $Maybe.Nothing
                           ,code: $Maybe.Nothing
                          ...
                          ,{name: "Off The Grid"
                           ...
                           ,tech: _U.list(["iOS","Multipeer Networking","Swift","P2P Networking"])
                          ...
                          ,{name: "Type The Web"
                           ...
                           ,tech: _U.list(["Firfox Addon","RamdaJS","JavaScript"])
                          ...
                          ,{name: "Laurier Course Graph"
                           ...
                           ,tech: _U.list(["ProcessingJS","JavaScript","Python"])
                          ...
                          ,{name: "Markov Chain Text Suggester"
                           ...
                           ,tech: _U.list(["Elm","Markov Chain"])
                           ,url: $Maybe.Just("https://davidrusu.github.io/markov_chain")
                           ,code: $Maybe.Just("https://github.com/davidrusu/markov_chain")
                           ,thumbnail: "./markov_chains.png"}]);
   var init = {projects: projects,header: $Header.init};
   var models = A3($Signal.foldp,update,init,actionMailbox.signal);
   var main = A2($Signal.map,view(actionMailbox.address),models);
   return _elm.Projects.values = {_op: _op,init: init,update: update,view: view,main: main,Model: Model};
};
