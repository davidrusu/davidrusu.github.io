...
Elm.Projects.make = function (_elm) {
   ...
   if (_elm.Projects.values)
   return _elm.Projects.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var viewTitle = F2(function (address,
   project) {
      return function () {
         var link = function () {
            var _v0 = project.url;
            ...
            {case "Just": return A2($Html.a,
                 _L.fromArray([$Html$Attributes.$class("icon_btn")
                              ,$Html$Attributes.href(_v0._0)]),
                 _L.fromArray([A2($Html.img,
                 _L.fromArray([$Html$Attributes.src("./link_icon.png")]),
                 _L.fromArray([]))]));
               case "Nothing":
               return A2($Html.div,
                 _L.fromArray([]),
         ...
         var github = function () {
            var _v2 = project.code;
            switch (_v2.ctor)
            {case "Just": return A2($Html.a,
                 _L.fromArray([$Html$Attributes.$class("icon_btn")
                              ,$Html$Attributes.href(_v2._0)]),
                 _L.fromArray([A2($Html.img,
                 _L.fromArray([$Html$Attributes.src("./GitHub-Mark-32px.png")]),
                 _L.fromArray([]))]));
               case "Nothing":
               return A2($Html.div,
                 _L.fromArray([]),
         ...
         var name = function () {
            ...
            switch (_v4.ctor)
            {case "Just": return A2($Html.a,
                 _L.fromArray([$Html$Attributes.href(_v4._0)]),
                 _L.fromArray([$Html.text(project.name)]));
               case "Nothing":
         ...
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("project_header")]),
         _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("project_name")]),
                      _L.fromArray([name]))
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("project_links")]),
                      _L.fromArray([link,github]))]));
      }();
   });
   var viewTag = F2(function (address,
   tag) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("tag")]),
      _L.fromArray([$Html.text(tag)]));
   });
   var viewProject = F2(function (address,
   project) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("project")]),
      _L.fromArray([A2($Html.img,
                   _L.fromArray([$Html$Attributes.$class("project_logo")
                                ,$Html$Attributes.src(project.thumbnail)]),
                   _L.fromArray([]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("project_details")]),
                   _L.fromArray([A2(viewTitle,
                                address,
                                project)
                                ,$Markdown.toHtml(project.description)
                                ,$Html.div(_L.fromArray([$Html$Attributes.$class("tag-list")]))(A2($List.map,
                                viewTag(address),
                                project.tech))]))]));
   });
